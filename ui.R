                                      ...
                                      tabPanel("METHODOLOGY",
                                               ...
                                               div(style = "padding: 0 35px 35px 35px; font-family: 'Roboto', sans-serif; line-height: 1.5;",
                                                   ...
                                                   HTML(
                                                     ...
                                                     "<p>3. The yearly reporting rate is quantified as the proportion of analysis visits in a year that generated at least one observation of the focal taxon. Because the reporting rate is expressed as a proportion of all relevant visits, it is assumed that this effectively controls for differences in overall observation effort across years (Ball et al. 2011).</p>",
                                                     ...
                                                     The quasiswap algorithm creates randomized matrices that maintain two strict biological constraints simultaneously (Gotelli 2000): fixed row sums (i.e. the number of species at each site stays the same); fixed column sums: the number of visits each species is detected in stays the same (species prevalence across space and time stays the same). Because of this, it is assumed that reporting rate anomalies are able to disentangle the observed pattern of over- or under-reporting while accounting for differences in sampling effort across locations and dates.
                                                     </p>",
                                                   ...
                                                   p("❏ GBIF: The Global Biodiversity Information Facility (2026) What is GBIF?. Available from https://www.gbif.org/what-is-gbif [6 Jul 2026]"),
                                                   p("❏ CALFIRE-FRAP (2026) Vegetation (fveg) - CALFIRE FRAP [ds1327], 2022. Available from https://data.ca.gov/dataset/california-vegetation-whrtype [6 Jul 2026]"),
                                                   p("❏ Rapacciuolo, G., Young, A. and Johnson, R. (2021), Deriving indicators of biodiversity change from unstructured community-contributed data. Oikos, 130: 1225-1239. https://doi.org/10.1111/oik.08215"),
                                                   p("❏ Ball, S. et al. 2011. Atlas of the hoverflies of Great Britain (Diptera, Syrphidae). – Centre for Ecology and Hydrology, Wallingford."),
